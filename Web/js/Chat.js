$(function() {
	...
	var host = (getURLParameter("ip")!=null) ? ("http://"+getURLParameter("ip")) : "http://localhost";
	var port = (getURLParameter("port")!=null) ? parseInt(getURLParameter("port")) : 14494;
	var nick;
	...
	socket.on("adminmsg", function(nick, msg) {
		addLine("<strong>[Admin]: </strong>" + decript(msg));
	});
	socket.on("report", function(nick, msg) {
